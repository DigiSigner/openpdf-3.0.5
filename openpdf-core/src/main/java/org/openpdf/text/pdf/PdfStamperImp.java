...
//        reader.getCatalog().remove(PdfName.ACROFORM);
    ...
    private void flatFreeTextFields() {
        ...
        for (int page = 1; page <= reader.getNumberOfPages(); ++page) {
            ...
            for (int idx = 0; idx < annots.size(); ++idx) {
                ...
                //Lonzak Fix: java.lang.ClassCastException: org.openpdf.text.pdf.PdfNull cannot be cast to org.openpdf.text.pdf.PdfDictionary
    ...
    /**
     * @see org.openpdf.text.pdf.PdfWriter#getPageReference(int)
     */
    ...
    /**
     * @see org.openpdf.text.pdf.PdfWriter#addAnnotation(org.openpdf.text.pdf.PdfAnnotation)
     */
    @Override
    ...
    /**
     * @see org.openpdf.text.pdf.PdfWriter#setOpenAction(org.openpdf.text.pdf.PdfAction)
     */
    ...
    /**
     * @see org.openpdf.text.pdf.PdfWriter#setOpenAction(java.lang.String)
     */
    ...
    /**
     * @see org.openpdf.text.pdf.PdfWriter#setThumbnail(org.openpdf.text.Image)
     */
    public void setThumbnail(org.openpdf.text.Image image) {
